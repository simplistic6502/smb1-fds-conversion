...
ColdBoot:    jsr InitializeMemory         ;clear memory using pointer in Y
             ...
             lda #%00100111               ;enable read mode and vertical mirroring
             sta FDS_CTRL_REG             ;write to FDS control register
             cli                          ;enable FDS IRQs
...
InitByteLoop: cpx #$01          ;check to see if we're on the stack ($0100-$01ff)
              ...
              cpy #$04          ;check to see if we're at $0100-$0103 (FDS pseudo-registers)
